...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.providers.keyCount': '{count} configured',
  'settings.providers.apiKeysEmpty': 'No API keys configured.',
  'settings.providers.apiKeyItem': 'Key {index}',
  'settings.providers.moveApiKeyUp': 'Move key {index} up',
  'settings.providers.moveApiKeyDown': 'Move key {index} down',
  'settings.providers.removeApiKey': 'Remove key {index}',
  'settings.providers.apiKeyLabel': 'Name',
  'settings.providers.apiKeyLabelPlaceholder': 'Optional name',
  'settings.providers.apiKeyWeight': 'Weight',
  'settings.providers.apiKeyEnabled': 'Enable key {index}',
  'settings.providers.addApiKey': 'Add key',
  'settings.providers.loadBalancing': 'Load balancing',
  'settings.providers.loadBalancingRoundRobin': 'Round robin',
  'settings.providers.loadBalancingWeighted': 'Weighted round robin',
  'settings.providers.loadBalancingFailover': 'Failover',
  'settings.providers.loadBalancingHint': 'Each request selects a key with this policy. Retryable failures move to another key.',
  'settings.providers.loadBalancingDisabledHint': 'Enable at least two keys to use load balancing.',
  'settings.providers.apiKeyKeep': 'API Key (leave blank to keep current)',
  'settings.providers.apiKeyHeaderStatus': 'Status',
  'settings.providers.apiKeyHeaderKey': 'Key',
  'settings.providers.apiKeyHeaderWeight': 'Weight',
  'settings.providers.apiKeyHeaderProxy': 'Proxy (optional)',
  'settings.providers.apiKeyHeaderActions': 'Actions',
  'settings.providers.apiKeyProxy': 'Proxy URL',
  'settings.providers.apiKeyProxyPlaceholder': 'http://host:port or socks5://user:pass@host:port',
  'settings.providers.apiKeyHeadersToggle': 'Show/hide custom headers for key {index}',
  'settings.providers.apiKeyHeadersTitle': 'Custom request headers',
  'settings.providers.apiKeyHeaderNameField': 'Header name (key {index})',
  'settings.providers.apiKeyHeaderValueField': 'Header value (key {index})',
  'settings.providers.apiKeyHeaderNamePlaceholder': 'Header name',
  'settings.providers.apiKeyHeaderValuePlaceholder': 'Value',
  'settings.providers.addApiKeyHeader': 'Add header',
  'settings.providers.removeApiKeyHeader': 'Remove header {headerIndex} from key {index}',
  'settings.providers.apiKeyTest': 'Test key {index}',
  'settings.providers.apiKeyTestSuccess': 'Key {index} is working ({latency} ms)',
  'settings.providers.apiKeyTestFailed': 'Key {index} failed: {error}',
  ...
  'settings.providers.modelCatalogTitle': 'Available models',
  'settings.providers.modelCatalogDesc': '{enabled} enabled of {total}. Enabled models appear in the chat model picker.',
  'settings.providers.modelCatalogAdd': 'Add model',
  'settings.providers.modelCatalogAddFetched': 'Add all {count}',
  'settings.providers.modelCatalogPick': 'Choose an available model ID',
  'settings.providers.modelCatalogDuplicate': 'This model is already in the available models list.',
  'settings.providers.modelCatalogEmpty': 'No available models yet. Add a model ID to switch to it in chat.',
  'settings.providers.modelCatalogCollapse': 'Collapse model settings',
  'settings.providers.modelCatalogExpand': 'Expand model settings',
  'settings.providers.modelCatalogRemove': 'Remove model',
  'settings.providers.modelCatalogContextWindow': 'Context window',
  'settings.providers.modelCatalogContextWindowHint': 'Optional. Use the model endpoint\'s actual context window.',
  'settings.providers.modelCatalog1m': 'Supports 1M context',
  'settings.providers.modelCatalog1mDesc': 'Enable only when the endpoint really offers a 1M token context window.',
