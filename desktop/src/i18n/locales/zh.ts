...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  'settings.providers.apiKeys': 'API 密钥',
  'settings.providers.keyCount': '已配置 {count} 个',
  'settings.providers.apiKeysEmpty': '还没有配置 API 密钥。',
  'settings.providers.apiKeyItem': '密钥 {index}',
  'settings.providers.moveApiKeyUp': '上移密钥 {index}',
  'settings.providers.moveApiKeyDown': '下移密钥 {index}',
  'settings.providers.removeApiKey': '删除密钥 {index}',
  'settings.providers.apiKeyLabel': '名称',
  'settings.providers.apiKeyLabelPlaceholder': '可选名称',
  'settings.providers.apiKeyWeight': '权重',
  'settings.providers.apiKeyEnabled': '启用密钥 {index}',
  'settings.providers.addApiKey': '添加密钥',
  'settings.providers.loadBalancing': '负载策略',
  'settings.providers.loadBalancingRoundRobin': '轮询',
  'settings.providers.loadBalancingWeighted': '加权轮询',
  'settings.providers.loadBalancingFailover': '故障转移',
  'settings.providers.loadBalancingHint': '每个请求按此策略选择密钥；可重试的失败会切换到下一把密钥。',
  'settings.providers.loadBalancingDisabledHint': '启用至少两把密钥后可使用负载均衡。',
  'settings.providers.apiKeyKeep': 'API 密钥（留空保持不变）',
  'settings.providers.apiKeyHeaderStatus': '状态',
  'settings.providers.apiKeyHeaderKey': '密钥',
  'settings.providers.apiKeyHeaderWeight': '权重',
  'settings.providers.apiKeyHeaderProxy': '代理地址（可选）',
  'settings.providers.apiKeyHeaderActions': '操作',
  'settings.providers.apiKeyProxy': '代理地址',
  'settings.providers.apiKeyProxyPlaceholder': 'http://host:port 或 socks5://user:pass@host:port',
  'settings.providers.apiKeyHeadersToggle': '显示/隐藏密钥 {index} 的自定义请求头',
  'settings.providers.apiKeyHeadersTitle': '自定义请求头',
  'settings.providers.apiKeyHeaderNameField': '请求头名称（密钥 {index}）',
  'settings.providers.apiKeyHeaderValueField': '请求头值（密钥 {index}）',
  'settings.providers.apiKeyHeaderNamePlaceholder': '请求头名称',
  'settings.providers.apiKeyHeaderValuePlaceholder': '值',
  'settings.providers.addApiKeyHeader': '添加请求头',
  'settings.providers.removeApiKeyHeader': '删除密钥 {index} 的请求头 {headerIndex}',
  'settings.providers.apiKeyTest': '测试密钥 {index}',
  'settings.providers.apiKeyTestSuccess': '密钥 {index} 可用（{latency} 毫秒）',
  'settings.providers.apiKeyTestFailed': '密钥 {index} 失败：{error}',
  ...
  'settings.providers.modelCatalogTitle': '可用模型列表',
  'settings.providers.modelCatalogDesc': '已启用 {enabled} 个，共 {total} 个。启用后会出现在聊天模型下拉中。',
  'settings.providers.modelCatalogAdd': '添加模型',
  'settings.providers.modelCatalogAddFetched': '添加全部 {count} 个',
  'settings.providers.modelCatalogPick': '选择可用模型 ID',
  'settings.providers.modelCatalogDuplicate': '该模型已在可用模型列表中。',
  'settings.providers.modelCatalogEmpty': '还没有可用模型。添加模型 ID 后，即可在聊天中切换。',
  'settings.providers.modelCatalogCollapse': '收起模型设置',
  'settings.providers.modelCatalogExpand': '展开模型设置',
  'settings.providers.modelCatalogRemove': '移除模型',
  'settings.providers.modelCatalogContextWindow': '上下文窗口',
  'settings.providers.modelCatalogContextWindowHint': '可选，按该模型的真实上下文窗口填写。',
  'settings.providers.modelCatalog1m': '支持 1M 上下文',
  'settings.providers.modelCatalog1mDesc': '仅在端点确实提供 100 万 token 上下文时启用。',
